...
func _ready() -> void:
	if not _STATE_CONTROLLER.current_state:
		EngineDebugger.send_message('hengo:debug_state', [67108864])
...
class Idle extends HengoState:
	func enter() -> void:
		#hen_dbg#EngineDebugger.send_message('hengo:debug_state', [1073741824])
		pass
...
class Walking extends HengoState:
	func enter() -> void:
		...
		#hen_dbg#EngineDebugger.send_message('hengo:cnode', [__hen_id__])
		#hen_dbg#EngineDebugger.send_message('hengo:debug_state', [34359738368])
	...
	func update(delta) -> void:
		...
		#hen_dbg#__hen_id__ += 274877906944
...
class Jumping extends HengoState:
	func enter() -> void:
		...
		#hen_dbg#EngineDebugger.send_message('hengo:cnode', [__hen_id__])
		#hen_dbg#EngineDebugger.send_message('hengo:debug_state', [2199023255552])
...
class Running extends HengoState:
	func enter() -> void:
		...
		_ref.speed = 10
		#hen_dbg#__hen_id__ += 17592186044416
		#hen_dbg#EngineDebugger.send_message('hengo:cnode', [__hen_id__])
		#hen_dbg#EngineDebugger.send_message('hengo:debug_state', [35184372088832])
